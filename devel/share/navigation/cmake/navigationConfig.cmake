...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/achu/aurora2018/aurora2018/src/navigation)
  set(navigation_DEVEL_PREFIX /home/achu/aurora2018/aurora2018/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/achu/aurora2018/aurora2018/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'robocpu <robocpu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/achu/aurora2018/aurora2018/src/navigation/${idir}'.  Ask the maintainer 'robocpu <robocpu@todo.todo>' to fix it.")
    endif()
